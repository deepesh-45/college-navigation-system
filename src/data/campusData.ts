...
export const DESTINATIONS = [
  ...ROOMS.map(r => ({ id: r.id, name: r.name, category: r.category, nodeId: r.nodeId })),
  ...FACILITIES.map(f => ({ id: f.id, name: f.name, category: f.category, nodeId: f.nodeId })),
  ...BUILDINGS.map(b => ({ id: b.id, name: b.name, category: b.category, nodeId: b.id }))
];
